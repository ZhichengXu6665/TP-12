  ...
  return (
    <div className="shoppinglist-page-container">
      ...
      <div className="shoppinglist-table">
        ...
        <ShoppingList shoppingList={shoppingList} updateShoppingList={updateShoppingList}/>
      </div>
      <Fab
        color="primary"
        aria-label="add"
        className="add-new-item-button"
        onClick={() => setShoppingAddingList(!showAddingShoppingList)}
        style={{
          position: 'fixed',
          bottom: '20px',
          right: '20px',
      ...
      >
        {showAddingShoppingList? <RemoveIcon /> : <AddIcon /> }
      </Fab>    
      <ImageButtons />  
    </div>
