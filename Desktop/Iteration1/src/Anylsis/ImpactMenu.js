  ...
  return (
    <div className="impact-menu">
      ...
      <div className="impact-options">
        ...
        <div className="impact-option" onClick={() => onSelectOption('water')}>
          <span className="option-text">Water</span>
          <img src={waterIcon} alt="Water" className="option-icon" /> {/* Water 图标 */}
        </div>
