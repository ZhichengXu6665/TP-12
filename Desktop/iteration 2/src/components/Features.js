...
import shoppingListImage from '../images/shopping_list.png';
import knowledgeImage from '../images/knowledge.png';
import carbonFootprintImage from '../images/co22.png'; // 新增的图片引用
        ...
        <div className="features-container">
            ...
            <div className="features-grid">
                ...
                <div className="feature-card">
                    ...
                    <div className="feature-content">
                        <img src={shoppingListImage} alt="Shopping List" className="feature-icon"/>
                        <div className="feature-text">
                            <h3>Shopping List</h3>
                            <p>Create a Shopping List That Saves You Time, Money, and Reduces Waste!</p>
                ...
                {/* Carbon Footprint: Step 6 */}
                <div className="feature-card">
                    <div className="step-label">Step 6</div>
                    <div className="feature-content">
                        <img src={carbonFootprintImage} alt="Carbon Footprint" className="feature-icon"/> {/* 新增图片 */}
                        <div className="feature-text">
                            <h3>Carbon Footprint</h3> {/* 标题 */}
                            <p>Discover your council's carbon impact with our carbon footprint tracker!</p> {/* 描述 */}
                            <Link to="/knowledge-hub#carbon-footprint" className="learn-more-button">Learn More &gt;&gt;</Link> {/* 跳转链接 */}
                        </div>
                    </div>
                </div>
            </div>
